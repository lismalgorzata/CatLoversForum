<template>
    <section class="vh-100-flexible" style="background-color: white;">
                ...
                <div class="col-md-6 col-lg-7 d-flex align-items-center">
                  <div class="card-body p-4 p-lg-5 text-black">
                    ...
                    <form>
                      ...
                      <p class="mb-3 pb-lg-2">Already have an account? <router-link :to="{ name: 'login' }">Login here</router-link>
                      </p>
                    </form>
                  </div>
                </div>
